...
class ThreeLayerConvNet(nn.Module):
    def __init__(self, in_channel, channel_1, channel_2, num_classes):
        ...
        # architecture defined above.                                          #
        ########################################################################
        self.conv2d1 = nn.Conv2d(in_channel, channel_1, 5, stride=1, padding=2)
        nn.init.kaiming_normal_(self.conv2d1.weight)
        self.Relu1   = nn.ReLU()
        self.conv2d2 = nn.Conv2d(channel_1, channel_2, 5, stride=1, padding=1)
        nn.init.kaiming_normal_(self.conv2d2.weight)
        self.Relu2   = nn.ReLU()
        self.num_classes = num_classes
        self.fc = nn.Linear(14400, self.num_classes)
    ...
    def forward(self, x):
        ...
        scores = self.Relu2(self.conv2d2(self.Relu1(self.conv2d1(x))))
...
channel_2 = 8
learning_rate = 1e-2
##print('train Sequential layers')
##model = nn.Sequential(
##    nn.Conv2d(3, channel_1, 5, stride=1, padding=2),
##    nn.ReLU(),
##    nn.Conv2d(channel_1, channel_2, 5, stride=1, padding=1),
##    nn.ReLU(),
##    Flatten(),
##    nn.Linear(14400, 10)
##
...
model = nn.Sequential(
    ...
    nn.Conv2d(3, channel_1, 3, stride=1, padding=2),
    nn.ReLU(),
    nn.MaxPool2d(2, stride=2, padding=0),
    
    nn.BatchNorm2d(channel_1, affine=False),
    nn.Conv2d(channel_1, channel_2, 3, stride=1, padding=1),
    nn.ReLU(),
    nn.MaxPool2d(2, stride=2, padding=0, dilation=1, return_indices=False, ceil_mode=False),

##    nn.Conv2d(channel_2, channel_3, 3, stride=1),
##    nn.ReLU(),
...
learning_rate = 1e-2
optimizer =  optim.SGD(model.parameters(), lr=learning_rate,
                     momentum= 0.8 , nesterov=True,weight_decay=0.01)
